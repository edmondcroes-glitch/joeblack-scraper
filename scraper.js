...
const WEBHOOK_URL   = 'https://www.solodipueblo.com/wp-admin/admin-ajax.php?action=lal_jb_update';
...
async function scrape() {
    ...
    try {
        ...
        await page.goto(JOEBLACK_URL, { waitUntil: 'domcontentloaded', timeout: 60000 });
